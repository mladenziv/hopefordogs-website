...
var H4D_I18N = {
  ...
  'adoptie.origin.intro': { nl: 'Omdat Servië en Bosnië buiten de EU liggen, gelden er strengere regels voor de invoer van honden. Daar hoef jij je geen zorgen over te maken: wij regelen alle benodigde documenten, vaccinaties en het volledige transport, zodat jouw hond veilig en volgens de regels naar Nederland, België, Duitsland of Oostenrijk reist.', de: 'Da Serbien und Bosnien außerhalb der EU liegen, gelten strengere Regeln für die Einfuhr von Hunden. Darum musst du dir keine Sorgen machen: Wir kümmern uns um alle erforderlichen Dokumente, Impfungen und den gesamten Transport, damit dein Hund sicher und regelkonform in die Niederlande, nach Belgien, Deutschland oder Österreich reist.', en: 'Because Serbia and Bosnia are outside the EU, stricter rules apply to importing dogs. You don’t have to worry about any of that: we arrange all the required documents, vaccinations and the entire transport, so your dog travels to the Netherlands, Belgium, Germany or Austria safely and by the rules.' },
  ...
  'adoptie.origin.c3d':   { nl: 'Een gecertificeerde dierentransporteur brengt jouw hond rechtstreeks van het asiel naar het afleverpunt in Nederland, België, Duitsland of Oostenrijk.', de: 'Ein zertifizierter Tiertransporteur bringt deinen Hund direkt vom Tierheim zum Abholpunkt in den Niederlanden, Belgien, Deutschland oder Österreich.', en: 'A certified animal transporter brings your dog straight from the shelter to the pickup point in the Netherlands, Belgium, Germany or Austria.' },
