...
var H4D_I18N = {
  ...
  'overons.hart.p1':    { nl: 'Hope for Dogs draait volledig op een klein team van vrijwilligers. We hebben geen grote organisatie achter ons en geen vaste subsidies die alles betalen. Alles wat we doen, doen we naast ons werk, gezin en andere verplichtingen. Gewoon omdat we vinden dat deze honden een kans verdienen.', de: 'Hope for Dogs l\u00E4uft vollst\u00E4ndig auf einem kleinen Team von Freiwilligen. Wir haben keine gro\u00DFe Organisation hinter uns und keine festen Subventionen, die alles bezahlen. Alles was wir tun, tun wir neben unserer Arbeit, Familie und anderen Verpflichtungen. Einfach weil wir finden, dass diese Hunde eine Chance verdienen.', en: 'Hope for Dogs runs entirely on a small team of volunteers. We have no large organization behind us and no fixed subsidies that cover everything. Everything we do, we do alongside our work, family and other commitments. Simply because we believe these dogs deserve a chance.' },
