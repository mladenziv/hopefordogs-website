...
var H4D_I18N = {
  ...
  // --- Honden page ---
  'honden.hero.sub':    { nl: 'Al onze adoptiehonden zijn buitenlandse straathonden uit Bosni\u00EB en Servi\u00EB, medisch behandeld en klaar voor een nieuw thuis.', de: 'Alle unsere Adoptionshunde sind Stra\u00DFenhunde aus Bosnien und Serbien, medizinisch versorgt und bereit f\u00FCr ein neues Zuhause.', en: 'All our adoptable dogs are street dogs from Bosnia and Serbia, medically treated and ready for a new home.' },
  'honden.hero.sub2':   { nl: ' Sommige verblijven nog in ons asiel, andere al in een opvanggezin in Nederland of Belgi\u00EB.', de: ' Einige leben noch in unserem Tierheim, andere schon in einer Pflegefamilie in den Niederlanden oder Belgien.', en: ' Some are still in our shelter, others already with a foster family in the Netherlands or Belgium.' },
  ...
  'doneer.trust.legal': { nl: 'Stichting Hope for Dogs Europe · KvK 91166500', de: 'Stichting Hope for Dogs Europe · KvK 91166500', en: 'Stichting Hope for Dogs Europe · KvK 91166500' },
  'doneer.trust.use':   { nl: 'Je gift gaat rechtstreeks naar voer, medische zorg en opvang van onze honden. Een maandelijkse gift wijzigen of stopzetten kan altijd — mail even naar info@hopefordogseurope.com.', de: 'Deine Spende geht direkt in Futter, medizinische Versorgung und Unterbringung unserer Hunde. Eine monatliche Spende ändern oder beenden? Schreib einfach an info@hopefordogseurope.com.', en: 'Your donation goes straight to food, medical care and shelter for our dogs. Want to change or stop a monthly donation? Just email info@hopefordogseurope.com.' },
  'doneer.trust.privacy': { nl: 'Lees ons privacybeleid', de: 'Unsere Datenschutzerklärung lesen', en: 'Read our privacy policy' },
