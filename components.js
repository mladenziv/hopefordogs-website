...
var H4D_I18N = {
  ...
  'index.cta.d25':  { nl: 'Volledige vaccinaties voor een puppy',      de: 'Vollst\u00E4ndige Impfungen f\u00FCr einen Welpen',     en: 'Complete vaccinations for a puppy' },
  ...
  'overons.hart.p1':    { nl: 'Hope for Dogs draait volledig op vrijwilligers. We hebben geen grote organisatie achter ons en geen vaste subsidies die alles opvangen. Alles wat we doen, doen we naast ons werk en gezin \u2014 simpelweg omdat we geloven dat deze honden iemand nodig hebben die voor hen opkomt.', de: 'Hope for Dogs l\u00E4uft vollst\u00E4ndig auf Freiwilligenbasis. Wir haben keine gro\u00DFe Organisation hinter uns und keine festen Subventionen. Alles was wir tun, tun wir neben unserer Arbeit und Familie \u2014 einfach weil wir glauben, dass diese Hunde jemanden brauchen, der f\u00FCr sie einsteht.', en: 'Hope for Dogs runs entirely on volunteers. We have no large organization behind us and no fixed subsidies. Everything we do, we do alongside our work and family \u2014 simply because we believe these dogs need someone to stand up for them.' },
  'overons.hart.p2':    { nl: 'Onze kracht zit in samenwerking. Mensen uit verschillende landen, met verschillende achtergronden, maar met hetzelfde hart. Sommigen helpen met opvang, anderen met adopties, transport, medische zorg of fondsenwerving. Iedereen draagt bij op zijn of haar manier.', de: 'Unsere St\u00E4rke liegt in der Zusammenarbeit. Menschen aus verschiedenen L\u00E4ndern, mit verschiedenen Hintergr\u00FCnden, aber mit demselben Herz. Einige helfen bei der Unterbringung, andere bei Adoptionen, Transport, medizinischer Versorgung oder Spendenwerbung. Jeder tr\u00E4gt auf seine Weise bei.', en: 'Our strength lies in collaboration. People from different countries, with different backgrounds, but with the same heart. Some help with shelter, others with adoptions, transport, medical care, or fundraising. Everyone contributes in their own way.' },
    ...
    var cardsHtml = teamMembers.map(function(m) {
      return '<div class="team-card">' +
        ...
        '<div class="team-card-overlay">' +
          ...
          '<div class="team-years">' + clockSvg + ' ' + m.years + '</div>' +
        '</div>' +
      '</div>';
    }).join('');
