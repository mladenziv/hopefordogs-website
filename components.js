...
var H4D_I18N = {
  ...
  // --- Honden page ---
  'honden.hero.sub':    { nl: 'Hier zie je alle honden die momenteel bij ons in of rondom het asiel verblijven. Daarnaast staan er ook hondjes tussen die al in Nederland/Belgi\u00EB in een opvanggezin verblijven!', de: 'Hier sehen Sie alle Hunde, die derzeit in oder um unser Tierheim leben. Dar\u00FCber hinaus gibt es auch Hunde, die bereits in den Niederlanden/Belgien in einer Pflegefamilie untergebracht sind!', en: 'Here you can see all the dogs currently staying in or around our shelter. There are also dogs that are already staying with foster families in the Netherlands/Belgium!' },
  ...
  'overons.faq2.a': { nl: 'Ja, alle honden zijn volledig gevaccineerd (inclusief rabi\u00EBs), gesteriliseerd/gecastreerd, ontwormd en gechipt voordat ze naar hun nieuwe thuis gaan. Ze reizen met een geldig EU-dierenpaspoort.', de: 'Ja, alle Hunde sind vollst\u00E4ndig geimpft (einschlie\u00DFlich Tollwut), sterilisiert/kastriert, entwurmt und gechipt, bevor sie in ihr neues Zuhause gehen. Sie reisen mit einem g\u00FCltigen EU-Heimtierausweis.', en: 'Yes, all dogs are fully vaccinated (including rabies), sterilized/neutered, dewormed, and microchipped before going to their new home. They travel with a valid EU pet passport.' },
  ...
  'adoptie.origin.title': { nl: 'Adopteren uit Servië & Bosnië', de: 'Adoptieren aus Serbien & Bosnien', en: 'Adopting from Serbia & Bosnia' },
  'adoptie.origin.sub':   { nl: 'Al onze honden komen uit de grensstreek van Servië en Bosnië, waar honderdduizenden zwerfhonden leven zonder opvang of hulp van de overheid. Een adoptie geeft één van hen een echte tweede kans.', de: 'Alle unsere Hunde stammen aus der Grenzregion von Serbien und Bosnien, wo Hunderttausende Straßenhunde ohne Unterkunft oder staatliche Hilfe leben. Eine Adoption gibt einem von ihnen eine echte zweite Chance.', en: 'All our dogs come from the border region of Serbia and Bosnia, where hundreds of thousands of stray dogs live with no shelter or government support. Adopting gives one of them a real second chance.' },
  'adoptie.origin.intro': { nl: 'Omdat Servië en Bosnië buiten de EU liggen, gelden er strengere regels voor de invoer van honden. Daar hoef jij je geen zorgen over te maken: wij regelen alle benodigde documenten, vaccinaties en het volledige transport, zodat jouw hond veilig en volgens de regels naar Nederland of België reist.', de: 'Da Serbien und Bosnien außerhalb der EU liegen, gelten strengere Regeln für die Einfuhr von Hunden. Darum musst du dir keine Sorgen machen: Wir kümmern uns um alle erforderlichen Dokumente, Impfungen und den gesamten Transport, damit dein Hund sicher und regelkonform in die Niederlande oder nach Belgien reist.', en: 'Because Serbia and Bosnia are outside the EU, stricter rules apply to importing dogs. You don’t have to worry about any of that: we arrange all the required documents, vaccinations and the entire transport, so your dog travels to the Netherlands or Belgium safely and by the rules.' },
  'adoptie.origin.c1':    { nl: 'EU-dierenpaspoort & documenten', de: 'EU-Heimtierausweis & Dokumente', en: 'EU pet passport & documents' },
  'adoptie.origin.c1d':   { nl: 'Elke hond reist met een geldig Europees dierenpaspoort, een microchip en alle vereiste reisdocumenten.', de: 'Jeder Hund reist mit einem gültigen EU-Heimtierausweis, einem Mikrochip und allen erforderlichen Reisedokumenten.', en: 'Every dog travels with a valid European pet passport, a microchip and all required travel documents.' },
  'adoptie.origin.c2':    { nl: 'Medisch volledig in orde', de: 'Medizinisch vollständig versorgt', en: 'Fully medically prepared' },
  'adoptie.origin.c2d':   { nl: 'Voor vertrek is elke hond gevaccineerd (inclusief rabiës), ontwormd, ontvlooid en gesteriliseerd of gecastreerd.', de: 'Vor der Abreise ist jeder Hund geimpft (einschließlich Tollwut), entwurmt, gegen Flöhe behandelt und sterilisiert oder kastriert.', en: 'Before departure every dog is vaccinated (including rabies), dewormed, treated for fleas and sterilized or neutered.' },
  'adoptie.origin.c3':    { nl: 'Veilig, gecertificeerd transport', de: 'Sicherer, zertifizierter Transport', en: 'Safe, certified transport' },
  'adoptie.origin.c3d':   { nl: 'Een gecertificeerde dierentransporteur brengt jouw hond rechtstreeks van het asiel naar het afleverpunt in Nederland of België.', de: 'Ein zertifizierter Tiertransporteur bringt deinen Hund direkt vom Tierheim zum Abholpunkt in den Niederlanden oder Belgien.', en: 'A certified animal transporter brings your dog straight from the shelter to the pickup point in the Netherlands or Belgium.' },
  ...
  'adoptie.stap1':   { nl: 'Kies een hond', de: 'W\u00E4hlen Sie einen Hund', en: 'Choose a dog' },
  'adoptie.stap1.d': { nl: 'Bekijk de beschikbare honden op onze website. Lees hun verhaal en kijk wie bij jouw situatie past. Twijfel je? Wij helpen je graag.', de: 'Sehen Sie sich die verf\u00FCgbaren Hunde auf unserer Website an. Lesen Sie ihre Geschichte und schauen Sie, wer zu Ihrer Situation passt. Unsicher? Wir helfen Ihnen gerne.', en: 'Browse the available dogs on our website. Read their story and see who fits your situation. Not sure? We\u2019re happy to help.' },
  'adoptie.stap2':   { nl: 'Kennismakingsgesprek', de: 'Kennenlerngespr\u00E4ch', en: 'Introduction call' },
  'adoptie.stap2.d': { nl: 'We plannen een gesprek (telefonisch of video) om jouw woon- en leefsituatie te bespreken. We kijken samen of de hond bij jou past.', de: 'Wir planen ein Gespr\u00E4ch (telefonisch oder per Video), um Ihre Wohn- und Lebenssituation zu besprechen. Wir schauen gemeinsam, ob der Hund zu Ihnen passt.', en: 'We schedule a call (phone or video) to discuss your living situation. Together we determine if the dog is a good fit for you.' },
  'adoptie.stap3':   { nl: 'Adoptieformulier', de: 'Adoptionsformular', en: 'Adoption form' },
  'adoptie.stap3.d': { nl: 'Je vult een adoptieformulier in met je gegevens en leefsituatie. Dit helpt ons om de juiste match te maken en de hond goed voor te bereiden.', de: 'Sie f\u00FCllen ein Adoptionsformular mit Ihren Daten und Ihrer Lebenssituation aus. Dies hilft uns, die richtige \u00DCbereinstimmung zu finden und den Hund gut vorzubereiten.', en: 'You fill in an adoption form with your details and living situation. This helps us make the right match and prepare the dog well.' },
  'adoptie.stap4':   { nl: 'Voorbereiden & transport', de: 'Vorbereitung & Transport', en: 'Preparation & transport' },
  'adoptie.stap4.d': { nl: 'De hond wordt medisch gecontroleerd, gevaccineerd, gechipt en gesteriliseerd. We regelen het transport van het asiel naar Nederland.', de: 'Der Hund wird medizinisch untersucht, geimpft, gechipt und sterilisiert. Wir organisieren den Transport vom Tierheim in die Niederlande.', en: 'The dog is medically checked, vaccinated, microchipped, and sterilized. We arrange transport from the shelter to the Netherlands.' },
  'adoptie.stap5':   { nl: 'Ophalen & wenperiode', de: 'Abholen & Eingew\u00F6hnung', en: 'Pickup & adjustment period' },
  'adoptie.stap5.d': { nl: 'Je haalt je hond op bij het afleverpunt. De eerste weken zijn spannend \u2014 wij blijven beschikbaar voor advies en begeleiding.', de: 'Sie holen Ihren Hund am Lieferpunkt ab. Die ersten Wochen sind aufregend \u2014 wir bleiben f\u00FCr Rat und Begleitung verf\u00FCgbar.', en: 'You pick up your dog at the delivery point. The first weeks are exciting \u2014 we remain available for advice and guidance.' },
  'adoptie.stap6':   { nl: 'Thuiscontrole', de: 'Hauskontrolle', en: 'Home check' },
  'adoptie.stap6.d': { nl: 'Na enkele weken doen we een check-up om te zien hoe het gaat. We willen zeker weten dat zowel jij als de hond gelukkig zijn.', de: 'Nach einigen Wochen f\u00FChren wir eine Kontrolle durch, um zu sehen, wie es l\u00E4uft. Wir m\u00F6chten sicherstellen, dass sowohl Sie als auch der Hund gl\u00FCcklich sind.', en: 'After a few weeks, we do a check-up to see how things are going. We want to make sure both you and the dog are happy.' },
