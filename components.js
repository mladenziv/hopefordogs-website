...
var H4D_I18N = {
  ...
  'adoptie.origin.c2d':   { nl: 'Voor vertrek is elke hond gevaccineerd (inclusief rabiës), ontwormd, ontvlooid en door een dierenarts gecontroleerd. Sterilisatie verschilt per hond.', de: 'Vor der Abreise ist jeder Hund geimpft (einschließlich Tollwut), entwurmt, gegen Flöhe behandelt und tierärztlich untersucht. Die Sterilisation ist von Hund zu Hund unterschiedlich.', en: 'Before departure every dog is vaccinated (including rabies), dewormed, treated for fleas and checked by a vet. Sterilization varies per dog.' },
  ...
  'adoptie.stap1':   { nl: 'Kies een hond', de: 'W\u00E4hle einen Hund', en: 'Choose a dog' },
  'adoptie.stap1.d': { nl: 'Bekijk de beschikbare honden en lees hun verhaal. Een foto vertelt nooit het hele verhaal, dus vraag ons gerust om meer foto\u2019s, video\u2019s of info over het karakter.', de: 'Sieh dir die verf\u00FCgbaren Hunde an und lies ihre Geschichte. Ein Foto erz\u00E4hlt nie die ganze Geschichte \u2013 frag uns also ruhig nach mehr Fotos, Videos oder Infos zum Charakter.', en: 'Browse the available dogs and read their story. A photo never tells the whole story, so feel free to ask us for more photos, videos or details about their character.' },
  'adoptie.stap2':   { nl: 'Adoptieformulier', de: 'Adoptionsformular', en: 'Adoption form' },
  'adoptie.stap2.d': { nl: 'Heb je interesse? Dan sturen we je een vragenlijst. Niet omdat er goede of foute antwoorden zijn, maar om te begrijpen hoe jouw dag eruitziet en welke hond daarbij past.', de: 'Interessiert? Dann schicken wir dir einen Fragebogen. Nicht weil es richtige oder falsche Antworten gibt, sondern um zu verstehen, wie dein Alltag aussieht und welcher Hund dazu passt.', en: 'Interested? We\u2019ll send you a questionnaire \u2014 not because there are right or wrong answers, but to understand what your daily life looks like and which dog fits it.' },
  'adoptie.stap3':   { nl: 'Kennismakingsgesprek', de: 'Kennenlerngespr\u00E4ch', en: 'Introduction call' },
  'adoptie.stap3.d': { nl: 'Daarna plannen we een persoonlijk gesprek. Rustig kennismaken, je vragen beantwoorden en samen kijken of het klikt. We bespreken ook de adoptievergoeding, het transport en wat je kunt verwachten.', de: 'Danach planen wir ein pers\u00F6nliches Gespr\u00E4ch. In Ruhe kennenlernen, deine Fragen beantworten und gemeinsam schauen, ob es passt. Wir besprechen auch die Adoptionsgeb\u00FChr, den Transport und was dich erwartet.', en: 'Then we schedule a personal conversation \u2014 getting to know each other calmly, answering your questions and seeing whether it clicks. We also discuss the adoption fee, transport and what to expect.' },
  ...
  'adoptie.kosten.note.tuig': { nl: 'Bij adoptie krijg je ook een passend anti-ontsnappingstuig mee. Zelf regel je alleen nog een riem.', de: 'Bei der Adoption bekommst du au\u00DFerdem ein passendes Anti-Ausbruch-Geschirr. Du musst nur noch eine Leine besorgen.', en: 'With the adoption you also receive a proper anti-escape harness. You only need to arrange a leash yourself.' },
